export const projects = [
    ...
    { 
        id: 3, 
        name: "Youtube bookmarker Chrome Extension",
        description:"A Chrome Extension built with JavaScript and Manifest V3 that allows users to bookmark moments within YouTube videos. Designed for repeat viewers, it simplifies revisiting specific segments without the need to manually search or scrub through video timelines.", 
        image: "/assets/Project3.jpg", 
        codeLink: "https://github.com/chiragmukheja/Youtube-Bookmarker.git" 
    }
  ];